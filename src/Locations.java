...
public class Locations {
	...
	public Locations(){		
		...
		n [2][6]= new Navigation("eisiger Wald", "Ein Schneesturm zieht auf! \n Der Wald in dem du umherirrst wird zur eisigen Falle für dich!", "Du findest ein silberfarbenes Schwert!", 95, vsEisKreatur,4);
		...
		n [3][3]= new Navigation("Das Dorf Praxx", "Du befindest dich in deinem Heimatdorf, die Vögel singen, die Leute treiben Handel... \n Hier ist die Welt noch in Ordnung!", "Du findest eine schäbige Waffe!", 0, vsNobody,1);
		n [3][4]= new Navigation("Nördlicher Feldweg", "Du kommst an einem Feldweg vorbei, du erinnerst dich das östlich von hier ein alter Bauernhof steht!", "Auf dem Boden glänzt etwas!", 45, vsBanditen,6);
		n [3][5]= new Navigation("Nord-Wald", "Du betrittst den nördlichen Wald! \n Du findest einen alten Pfad der dich durch den Wald führt!", "Du findest ein Schwert!", 60, vsWolf,3);
		...
		n [5][1]= new Navigation("Stadt: New Altmeria (Norden)", "Du wanderst durch die durch die Gassen von New Altmeria und kommst an der Zitadelle der Stadt an...", "Nachdem du den Schwarzen Ritter helfenhaft besiegt hast nimmst du seine prächtige Rüstung an dich!", 100, vsSchwarzerRitter,9);
		...
		n [5][5]= new Navigation("Einsamer Berg Erebor", "In der großen Ebene davor findet eine erbitterte Schlacht statt... \n Wegen deiner friedfertigen Natur entschließt du dich das gewaltsame Treiben zu meiden....", "Leider nichts was wertvoll wäre...", 10, vsZwerg);
		n [5][6]= new Navigation("Nördliche Steppen von Lycia", "Ein weite Steppe \n", "nichts", 100, vsSamurai);
		n [6][0]= new Navigation("Kathedrale von New Altmeria", "Du betrittst die Kathedrale um ein stilles Gebet zu sprechen... \n", "Du findest ein ziemlich coole Musik-Sammlung, leider kannst du nicht so viel tragen und du beschließt sie zurück zu lassen...", 100, vsLordNatas, "Da bemerkst du wie sich ein Portal öffnet und der Leibhaftige heraussteigt \n Deine Stimmung verschlechtert sich rapide...");
		...
		n [6][3]= new Navigation("The Void", "Als du das Gebiet betritts zerbricht um dich herum die Realität\n Unfähig das sich vor dir absielende Schauspiel zu begreifen bist du dem Wahnsinn nahe\n Du verlierst 1 Punkt Mentale Belastbarkeit", "Du bemerkst eine versteckte Luke auf den Boden, als du sie öffnest und hinein steigst bemekst du,\n dass du dich in etwas befindest was für dich wie ein riesiger Metall-Mensch wirkt.", 100, vsLeerenKrieger,10);
		n [6][4]= new Navigation("Heiliger Hein", "Auf einer Lichtung findest du ein Schwert welches in einem Stein steckt... Der versuch es herauszuziehen scheitert kläglich...", "Als du erneut versuchst das Schwert herauszuziehen hat der uralte Stein endlich erbarmen und gibt das Schwert frei!", 100, vsStatue,0);
		n [6][5]= new Navigation("Verlassene Stadt", "Die Stadt wirkt verlassen... \n", "Nur verfallene Gebäude...", 50, vsBewohner);
